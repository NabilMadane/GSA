    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url(); ?>" class="logo">
          ...
          <span class="logo-lg"><b>GS</b>Analyse</span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url(); ?>logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Se déconnecter</a>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <section class="sidebar">
          ...
          <!--  <li class="treeview">
            ...
            ?>
              <?php
              if($is_admin == 1 ||
                  (array_key_exists('Dossier', $access_info)
                      && ($access_info['Dossier']['list'] == 1 || $access_info['Dossier']['total_access'] == 1)))
              {
                  ?>
                  <li>
                      <a href="<?php echo base_url(); ?>dossierListing">
            ...
            ?>
              <?php
              if($is_admin == 1 ||
                  (array_key_exists('Analyse', $access_info)
                      && ($access_info['Analyse']['list'] == 1 || $access_info['Analyse']['total_access'] == 1)))
              {
                  ?>
                  <li>
                      <a href="<?php echo base_url(); ?>analyseListing">
              ...
              <?php
              if($is_admin == 1 ||
                  (array_key_exists('Labo', $access_info)
                      && ($access_info['Labo']['list'] == 1 || $access_info['Labo']['total_access'] == 1)))
              {
                  ?>
                  <li>
                      <a href="<?php echo base_url(); ?>laboListing">
                          <i class="fa fa-tasks"></i>
