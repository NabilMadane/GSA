...
class Booking extends BaseController
{
    ...
    function bookingListing()
    {
        ...
        else
        {
			...
			$returns = $this->paginationCompress ( "bookingListing/", $count, 3 );
            
            $data['records'] = $this->bm->bookingListing($searchText, $returns["page"], $returns["segment"]);
            
            $this->global['pageTitle'] = 'GSA : Booking';
    ...
    function add()
    {
        ...
        {
            $this->global['pageTitle'] = 'GSA : Add New Booking';
    ...
    function edit($bookingId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'GSA : Edit Booking';
