...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'GSA : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'GSA : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'GSA : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'GSA : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'GSA : User Login History';
    ...
    function profile($active = "details")
    {
        ...
        $this->global['pageTitle'] = $active == "details" ? 'GSA : My Profile' : 'GSA : Change Password';
